...
package doab.uin.mvb.camera.camera;
...
import doab.uin.mvb.camera.CLog;
import doab.uin.mvb.camera.camera.OpenCameraException;
import doab.uin.mvb.camera.camera.OpenCameraException.OpenType;
import doab.uin.mvb.camera.camera.PrepareCameraException;
import doab.uin.mvb.camera.camera.RecordingSize;
...
public class CameraWrapper {
    ...
    public RecordingSize getSupportedRecordingSize(int width, int height) {
        Size recordingSize = getOptimalSize(getSupportedVideoSizes(VERSION.SDK_INT), width, height);
